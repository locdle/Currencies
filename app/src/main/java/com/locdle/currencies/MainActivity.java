...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null
                && (PreferencesManager.getString(this, FOR) == null &&
                PreferencesManager.getString(this, HOM) == null)) {
            ...
            PreferencesManager.setString(this, FOR,"CNY");
            PreferencesManager.setString(this, HOM,"USD");


        } else {

            mForSpinner.setSelection(findPositionGivenCode(PreferencesManager.getString(this,
                    FOR), mCurrencies));
            mHomSpinner.setSelection(findPositionGivenCode(PreferencesManager.getString(this,
                    HOM), mCurrencies));
        }
...
//        return false;
    ...
    private void invertCurrencies() {
        ...
        PreferencesManager.setString(this, FOR, extractCodeFromCurrency((String)
                mForSpinner.getSelectedItem()));
        PreferencesManager.setString(this, HOM, extractCodeFromCurrency((String)
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (parent.getId()) {
            ...
            case R.id.spn_for:
                PreferencesManager.setString(this, FOR,
                        extractCodeFromCurrency((String)mForSpinner.getSelectedItem()));
                break;

            case R.id.spn_hom:
                PreferencesManager.setString(this, HOM,
